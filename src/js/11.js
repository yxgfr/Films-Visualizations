        ...
        var f, c, u = {
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    this.rects = this.rect_g.append("rect").attr("x", 40).attr("y", -10).attr("width", 60).attr("height", 20).attr("fill", "black").attr("stroke", function(e) {
                        return e.color ? "#" + e.color : t.config.linkColor
                    }).attr("stroke-width",3),
                    this.texts = this.rect_g.append("text").attr("x", 40).attr("y", 5).attr("text-anchor", "middle").style("font-size", 18).text(function(t) {
                        return t.relation
                    }),
                    this.circles = this.relMap_g.selectAll("circle.circleclass").data(this.config.nodes).enter().append("circle").attr("class", "circleclass").style("cursor", "pointer").attr("fill", function(t) {
                        ...
                        i.h(this).attr("stroke-width", t.strokeWidth),
                        i.h(this).attr("stroke", t.strokeColor),
